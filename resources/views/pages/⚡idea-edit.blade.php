...
new class extends Component {
    ...
    public function update()
    {
        ...
        $this->image_path =  $this->image_path->store('feature_imgs', 'public');
            ...
            $this->image_path = $this->idea->image_path;
        }
        $idea  = $this->idea->update($this->only(['title', 'description', 'status', 'resources', 'image_path']));
    ...
    public function addStep()
    {
       ...
       $this->idea->steps()->create(['description' => $this->step]);
       $this->steps = $this->idea->steps;
    }
...
<div>
    <div class="p-6 max-w-3xl mx-auto space-y-8">
        ...
        <div class="flex items-center justify-between border-b border-zinc-200 pb-4 dark:border-zinc-800">
            ...
            <flux:button wire:click="cancel" variant="ghost" icon="x-mark" size="sm">Cancel</flux:button>
        </div>
        ...
        <form class="space-y-6" wire:submit="update">
                    ...
                    <div
                        ...
                        @foreach ($steps as $step)
                            <div class="flex items-center gap-3">
                                ...
                                <flux:button wire:click="deleteStep({{ $step->id }})" icon="trash" variant="ghost" color="red" size="sm" inset />
                            </div>
                        @endforeach
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-zinc-200 dark:border-zinc-800">
                ...
                <flux:button variant="primary" color="green" type="submit">Update Idea</flux:button>
            </div>
